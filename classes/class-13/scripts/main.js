...
// Una forma de trabajar con ternarios de múltiples líenas de código (es lo que necesitamos ejecutar)
const intentarDenuevo = () => {
    // Varias líneas de código para permitir un reintento
    console.log("--> Intentalo una vez más");
}

const bloquearCuenta = () => {
    // Varias líneas de código para bloquear la cuenta por intentos superados
    console.log("--> Cuenta bloqueada <--");
}

(intentos < LIMITE) ? intentarDenuevo() : bloquearCuenta();

// Ejemplo de ternario con múltiples líneas de código usando funciones anónimas
intentos < LIMITE ?
    (() => {
        // Varias líneas de código para permitir un reintento
        console.log("--> Intentalo una vez más");
